RESOURCE_PATH = File.join(File.dirname(__FILE__), '/resources').freeze
...
module Resources
  ...
  class Resource
    ...
    BASE_PATH = File.join(File.dirname(__FILE__), 'data').freeze
...
require File.join(RESOURCE_PATH, 'agency')
require File.join(RESOURCE_PATH, 'calendar')
require File.join(RESOURCE_PATH, 'frequency')
require File.join(RESOURCE_PATH, 'route')
require File.join(RESOURCE_PATH, 'shape')
require File.join(RESOURCE_PATH, 'stop')
require File.join(RESOURCE_PATH, 'stop_time')
require File.join(RESOURCE_PATH, 'transfer')
require File.join(RESOURCE_PATH, 'trip')
